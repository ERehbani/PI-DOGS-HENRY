...
Crear una Aplicación web donde se puedan encontrar diferentes tipos de perros 🐕, utilizando una API externa. Y a partir de ella, poder entre otras cosas:

  ✅ Buscar perros

  ✅ Filtrarlos por raza / Ordenarlas por peso y por orden alfabetico, de manera ascendente ⏫ y descendente ⏬.
